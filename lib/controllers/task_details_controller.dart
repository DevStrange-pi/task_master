...
class TaskDetailsController extends GetxController {
  ...
  final bool statusFlag = Get.arguments["taskStatus"] == "completed" ? false : true;
  ...
  void onInit() async {
    ...
    taskStatusSelected.value = Get.arguments["taskStatus"]?.toString().capitalizeFirst ?? "Pending";
  ...
  void createDropdownOptions() {
    ...
    for (var employee in employeeList) {
      int indx = assignSelected.indexWhere(
          (element) => element.value == employee.name);
      if (indx != -1) {
  ...
  Future<bool> updateTaskDetails(String name, String desc, String type,String status,
